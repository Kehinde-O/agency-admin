...
export default function PendingPropertiesPage() {
  ...
  useEffect(() => {
    setPageTitle('Pending Properties', 'Review and approve property listings')
  }, [setPageTitle])
  ...
  // Load pending properties from API
  const loadPendingProperties = useCallback(async () => {
    try {
      setIsLoading(true)
      setError(null)
      const response = await apiService.getPendingProperties(pagination.page, pagination.limit, filterStatus)
  ...
  }, [pagination.page, filterStatus, loadPendingProperties])
  ...
  const handleViewProperty = (propertyId: string) => {
    router.push(`/pending-properties/${propertyId}`)
  }
